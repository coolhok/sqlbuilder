...
func TestStructUpdate(t *testing.T) {
	...
	if expected := []interface{}{123, "name", 2, 1234567890}; !reflect.DeepEqual(expected, args) {
...
func TestStructUpdateForTag(t *testing.T) {
	...
	if expected := []interface{}{123, "name", 2}; !reflect.DeepEqual(expected, args) {
		t.Fatalf("invalid args. [expected:%v] [actual:%v]", expected, args)
	}
}
...
func TestStructInsertInto(t *testing.T) {
	...
	if expected := []interface{}{123, "name", 2, 1234567890, 456, "Du Huan", 2, 1234567890}; !reflect.DeepEqual(expected, args) {
		t.Fatalf("invalid args. [expected:%v] [actual:%v]", expected, args)
	}
}
...
func TestStructInsertIntoForTag(t *testing.T) {
	...
	if expected := []interface{}{123, "name", 2, 456, "Du Huan", 2}; !reflect.DeepEqual(expected, args) {
		t.Fatalf("invalid args. [expected:%v] [actual:%v]", expected, args)
	}
